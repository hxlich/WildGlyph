...
local aura = (function()
	...
	return {
		...
		UpdateUI = function()
			knowsAura = WG_Lib_Spellbook.GetIsSpellLearned(WILDGLYPH_T.Spellbook.Thorns)
				or not Wild_Glyph_Store.IsLockedFrames
			isActive, timeLeft = WG_Lib_Aura_GetIsActiveTimeLeftByTexture(WildGlyph.Icon.Thorns)
			lastUpdate = 0
...
local createUI = function()
	...
	f.Icon:SetBackdrop({ bgFile = WildGlyph.Icon.Thorns, tile = false })
